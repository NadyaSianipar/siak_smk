              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?= $profil['jurusan']; ?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?= $profil['tingkat']; ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">NISN</div>
                    <div class="col-lg-9 col-md-8"><?= $profil['nisn']; ?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?= $profil['nama_ortu']; ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Alamat Orang Tua/Wali</div>
                    <div class="col-lg-9 col-md-8"><?= $profil['alamat_ortu']; ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Pekerjaan Orang Tua/Wali</div>
                    <div class="col-lg-9 col-md-8"><?= $profil['pekerjaan_ortu']; ?></div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action="<?= base_url('ProfilSiswa/do_upload'); ?>" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id_siswa" value="<?= $profil['id_siswa']; ?>">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      <label for="Job" class="col-md-4 col-lg-3 col-form-label">Nama Orang Tua/Wali</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="nama_ortu" type="text" class="form-control" id="Job" value="<?= $profil['nama_ortu']; ?>">
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="Job" class="col-md-4 col-lg-3 col-form-label">Alamat Orang Tua/Wali</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="alamat_ortu" type="text" class="form-control" id="Job" value="<?= $profil['alamat_ortu']; ?>">
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="Job" class="col-md-4 col-lg-3 col-form-label">Pekerjaan Orang Tua/Wali</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="pekerjaan_ortu" type="text" class="form-control" id="Job" value="<?= $profil['pekerjaan_ortu']; ?>">
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form action="<?= base_url('ProfilSiswa/changePassword'); ?>" method="POST">
